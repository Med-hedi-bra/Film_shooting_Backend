 ...
 * @swagger
 * tags:
 *   name: PreDemands Route
 *   description: API operations for managing Predemands
 */
 ...
 * /predemand/{idUser}:
 *   get:
 *     summary: Get all Predemands
 *     tags:
 *       - PreDemands Route
 *     description: This API for getting the last predemand for a user
 *     produces:
 *       - application/json
 *     responses:
 *       '200':
 *         description: OK
 *         schema:
 *          $ref: '#/definitions/PreDemandResponse'
 *           
 *          
 *       '400':
 ...
 *
 *   post:
 *     summary: Add a new predemand or update the laste one
 *     tags:
 *       - PreDemands Route
 *     description: This API is for adding a new Predemand or updated an existing one
 *     consumes:
 *       - application/json
 *     parameters:
 *       - in: body
 *         name: demand
 *         schema:
 *           $ref: '#/definitions/PreDemandRequest'
 *     responses:
 *       '201':
 *         description: Predemand updated with success
 *       '400':
 *         description: Bad request
 *       '500':
 *         description: Internal server error
